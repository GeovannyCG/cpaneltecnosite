    ...
    <div class="grid-container">
        ...
        <main class="main-container" id="mainContainer">
            ...
            <div class="container-table">
                ...
                <button type="button" class="btn btn-secondary btn-mostrar-mas">Mostrar mas</button>
            </div>
            ...
            if ($permisos != true) {
            ?>
                <!-- Tabla para mostrar las solicitudes de actualizacion de alguna cotizacion de (x) usuario-->
                <div class="container-table">
                    <!-- Encabezado de contendor de tabala con buscador -->
                    <div class="header-container-table">
                        <!-- Titulo -->
                        <h5><i class="bi bi-list-ul"></i> Mis solicitudes para actualizacion de cotizaciones</h5>
                        ...
                        <div class="acciones">
                            ...
                            <div class="input-group mb-3 buscador">
                                <input type="text" class="form-control input-buscador" placeholder="Buscar solicitud" aria-label="Buscar solicitud" aria-describedby="button-addon2">
                                <button class="btn btn-outline-secondary btn-search" type="button" id="button-addon2"><i class="bi bi-search"></i></button>
                            </div>
                        </div>
                    </div>
                    <table class="table table-dark table-striped">
                        ...
                        <tbody id="tb-mis-solicitudes-edicion">
                            <tr>
                                <td>
                                    <p class="placeholder-glow">
                                        <span class="placeholder col-10"></span>
            ...
            <?php
            // Verificar si el usuario iniciado es administrador para poder mostrarlo
            if ($permisos != true) { //HAY QUE CAMBIARLO PARA QUE LO VEAN SOLO ADMINISTRADORES
            ?>
                <!-- Tabla para mostrar las solicitudes de cotizacion enviadas por los usuario -->
                <div class="container-table">
                    <!-- Encabezado de contendor de tabala con buscador -->
                    <div class="header-container-table">
                        <!-- Titulo -->
                        <h5><i class="bi bi-list-ul"></i> Solicitudes de actualizacion de cotizaciones</h5>
                    ...
                    <table class="table table-dark table-striped">
                        ...
                        <tbody id="tb-todas-solicitudes-edicion">
                            <tr>
                                <td>
                                    <p class="placeholder-glow">
                                        <span class="placeholder col-10"></span>
