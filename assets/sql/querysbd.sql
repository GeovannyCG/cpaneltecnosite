...
--!TABLA DE SOLICITUDES DE DESBLOQUEO

-- CREATE TABLE unlock_request_tecnosite(
-- 	id_ur int AUTO_INCREMENT,
--     date_request_ur datetime not null,
--     state_request_ur varchar(20) not null,
...
--! TABLA PARA HISTORIAL DE ACCIONES

-- CREATE TABLE record_activity_tecnosite(
...
-- !TABLA PARA LAS SOLICITUDES DE ACTUALIZACION EN COTIZACIONES

-- CREATE TABLE update_request_tecnosite(
--     id_ur int auto_increment,
...
--     primary key(id_ur),
--     foreign key (id_user) references users_tecnosite(id_u),
--     foreign key (invoice_q) references quotations_tecnosite(invoice_q)
-- );
